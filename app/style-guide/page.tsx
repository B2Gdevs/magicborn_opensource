      ...
      <div className="container mx-auto px-12 py-12 max-w-6xl">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#0a0a0f - Primary background</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#1a1a2e - Card backgrounds</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#16213e - Hover states</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#0f1419 - Deepest shadows</div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#c94a2a - Fire, action, primary CTA</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#ff6b4a - Highlights, glows</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-lg bg-moss border border-moss-glow"></div>
                  <div>
                    <div className="font-semibold text-moss-glow">Moss</div>
                    <div className="text-sm text-text-muted">#2d5a3d - Nature, growth</div>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-text-muted">#4a2c5a - Mystical, magic</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <div className="text-sm text-text-muted">#ffd89b - Headings, emphasis</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="card space-y-4">
            ...
            <div>
              <h3 className="text-xl font-semibold mb-2 text-moss-glow">Organic & Natural</h3>
        ...
        <section className="mb-16">
          ...
          <div className="card space-y-4">
            ...
            <div>
              <h3 className="font-semibold mb-2">When to Use Moss (Green)</h3>
              <ul className="list-disc list-inside text-text-secondary space-y-1 ml-4">
                <li>Nature and growth-related content</li>
                <li>Positive feedback and success states</li>
                <li>Healing and regeneration effects</li>
              </ul>
            </div>
            <div>
