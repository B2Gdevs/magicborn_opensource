      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Implement virtual scrolling for large media grids", completed: true },
            { text: "Fix infinite scroll detection - Intersection Observer not reliably triggering when scrolling to bottom (known issue)", completed: false },
