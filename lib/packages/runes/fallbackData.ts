// lib/packages/runes/fallbackData.ts
// Hardcoded fallback rune data - kept for backward compatibility and as fallback
// TODO: Remove this once all runes are in Payload CMS
...
export const HARDCODED_RUNES: Record<RuneCode, RuneDefinition> = {
  A: {
    id: "A",
    name: "Air",
    code: "A",
